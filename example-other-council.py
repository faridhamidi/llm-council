...
# Data source toggles
USE_DYNATRACE = os.getenv("USE_DYNATRACE", "true").lower() == "true"  # true = Dynatrace MCP, false = local fallback
REQUIRE_DYNATRACE = os.getenv("REQUIRE_DYNATRACE", "true").lower() == "true"  # if true, exit when live data is unavailable

# Webex toggles
WEBEX_ENABLED = os.getenv("WEBEX_ENABLED", "true").lower() == "true"

# Webex tokens/identifiers
WEBEX_API_BASE = os.getenv("WEBEX_API_BASE", "https://webexapis.com/v1")
WEBEX_BOT_TOKEN = os.getenv("WEBEX_BOT_TOKEN", "ZGZjYTJmMDQtNTA0Yi00YzVmLWI4NjMtZTcyOWI4ZDUyNWRhYmExOTk5ZjUtMjQz_PF84_ba976b32-bed9-4268-9db7-7a60d5d0f12c")
WEBEX_BOT_ID = os.getenv(
    "WEBEX_BOT_ID",
    "Y2lzY29zcGFyazovL3VzL0FQUExJQ0FUSU9OLzhjYmE5ZWFiLTZhNTctNGM2OC1hYzg5LTkxYjkwMDRkNzE5ZA",
)
WEBEX_ROOM_ID = os.getenv(
    "WEBEX_ROOM_ID",
    "Y2lzY29zcGFyazovL3VzL1JPT00vZTA2YmMxZDAtMTQxMS0xMWViLThkYjQtN2IzOWRjNWI2M2E0",
)

# Bedrock token
# Put your Bedrock API key here (or set BEDROCK_API_KEY environment variable).
BEDROCK_API_KEY = "bedrock-api-key-"  # Example: "your-short-term-key-here"
